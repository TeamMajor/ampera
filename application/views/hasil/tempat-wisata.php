						...
						<div class="panel panel-default">
							<div class="panel-body">
									...
									<div class="col-sm-8">
										...
										<h3 style="margin-top:5px;">Tempat wisata </h3>
										<h2 style="margin-top:5px;"><?php echo $b->nama; ?> </h2>
										<?php echo anchor("cari/informasi-matkul/".$b->id,"Lihat Selengkapnya &nbsp; <i class='fa fa-chevron-right'></i>",array("class"=>"btn btn-default col-sm-12 ")) ?>	
									</div>
