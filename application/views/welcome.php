	...
	<div class="container-fluid" >
		...
		<div  class="col-sm-12 col-lg-12 col-xs-12" >
			<div class="col-sm-8 col-md-8 col-xs-12 col-sm-offset-4" id="gambar-logo">
				<img id="ampera-logo" src="http://localhost/ampera/gambar/logo-ampera.png" height="400" width= "400" />
			</div>
		...
		<div class="col-sm-6 col-md-6 col-xs-12 col-sm-offset-3" id="cari" style="border:0px solid #000000; margin-top:10px;">
					<form name="form1" class="form-horizontal" action="http://localhost/ampera/welcome/token" method="get" style="margin-top:10px;">
